...
//   allowed_shifts {shifts, strict?}  αποκλειστική λίστα επιτρεπτών ωραρίων
//                               (strict:true → δεν παρακάμπτεται ούτε από το Κ9)
...
//   prefer_morning_evening      (soft) προτίμηση πρωινών ΚΑΙ βραδινών (έναρξη
//                               19:00+), αποφυγή απογευματινών (12:00-18:59)
...
const RULES = {
  'ΡΙΖΟΥ ΒΙΚΥ': [
    { d: 'Προτιμάται ΕΝΤΟΝΑ πρωινή βάρδια (σχεδόν πάντα πρωί· απόγευμα μόνο αν δεν βγαίνει αλλιώς). Πριν: εναλλαγή ανά εβδομάδα — άλλαξε 18/07/2026.', r: { type: 'prefer_morning', strong: true } },
